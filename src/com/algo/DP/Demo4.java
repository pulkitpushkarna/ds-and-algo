...
public class Demo4 {
    public static void main(String[] args) {
        ...
        String str2 = "JavaLanguageProgramming";
        int m = str1.length();
        int n = str2.length();
    ...
    public static int lcs(String str1, String str2, int m, int n, int lcsCount, int[][][] cache) {
        ...
        if (str1.charAt(m - 1) == str2.charAt(n - 1)) {
            lcsCount1 = lcs(str1, str2, m - 1, n - 1, lcsCount + 1, cache);
        }
        int lcsCount2 = lcs(str1, str2, m - 1, n, 0, cache);
        int lcsCount3 = lcs(str1, str2, m, n - 1, 0, cache);
    ...
    public static int lcs(String str1, String str2, int m, int n, int lcsCount) {
        ...
        int lcsCount2 = lcs(str1, str2, m - 1, n, 0);
        int lcsCount3 = lcs(str1, str2, m, n - 1, 0);
